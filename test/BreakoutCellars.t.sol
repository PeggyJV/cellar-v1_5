...
contract BreakoutCellarsTest is Test {
    ...
    Cellar private breakoutBTC;
    Cellar private breakoutETH;

    function setUp() external {
        breakoutBTC = Cellar(0x4986fD36b6b16f49b43282Ee2e24C5cF90ed166d);
        breakoutETH = Cellar(0x3F07A84eCdf494310D397d24c1C78B041D2fa622);
    }

    function testCellars() external {
        _testWBTCCellar(breakoutBTC);
        _testWETHCellar(breakoutETH);
    }
